...
Linux 主线内核 [drivers/base/platform.c](../../third_party/linux_mainline/drivers/base/platform.c)：
...
**修改后的文件：**
- [beep_driver.c](../../driver/beep/alpha-board/beep_driver.c#L166): `compatible = "imxaes,beep"`
- [imx6ull-aes-beep.dts](../../driver/device_tree/alpha-board/beep/imx6ull-aes-beep.dts#L18): `compatible = "imxaes,beep"`
...
- [主线内核 platform_match 源码](../../third_party/linux_mainline/drivers/base/platform.c#L1376-L1399)
- [设备树规范](https://devicetree-specification.readthedocs.io/)
- [原始分析记录](../../beep_reason.md)
